...
- Launch an AWS T2 Large Instance. Use the image as Ubuntu. You can create a new key pair or use an existing one. Enable HTTP and HTTPS settings in the Security Group and open all ports (not best case to open all ports but just for learning purposes it's okay).
   <img width="758" height="168" alt="image" src="https://github.com/user-attachments/assets/7453e4fe-e130-4e8c-ad35-f25e1688dfdd" />
...
- Click on the first result, Click on the Login on the top right. 
...
- Usually, there would have a disk mounted to the data directory.I will simply create a /data directory. Also, you need a folder for Prometheus configuration files.
...
- <img width="823" height="344" alt="image" src="https://github.com/user-attachments/assets/fc747cd9-7c27-4d1d-bec5-12665af1d779" />
